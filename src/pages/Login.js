  ...
  <div className='login'>
    ...
    <Row gutter={16} className='d-flex align-items-center'>
      ...
      <Col lg={16} style={{position: 'fixed'}}>
        <img src='https://images.unsplash.com/photo-1601328737333-e2971a43867a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80' width="1500em"/>
